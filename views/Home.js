...
export default () => html`
  <div>
    <h1>Elite Freestyle Karate Performance Tracking App</h1>
      <p>During your journey, whether you are beginning White Belts or experienced Black Belts,<br>
  You have, or will in the future, needed to track your performance of the skills you learn.<br>
  You will also have a need to track the progress you are making towards your next goal.<br>
  This EFK application is for you, the martial artist.  You have accepted the challenge of<br>
  embarking on this life ong journey, now we place the responsibility of tracking performance<br>
  and requirements in your capable hands.  Your Sensei's will teach you all of the skills<br>
  and techniques, they will push you to ever greater heights and they will take pride in<br>
  your achievements.  You will listen to them, apply what they teach and take responsibility<br>
  for achieving your goals.  Your Sensei's can guide, push and pull you, but you will have to<br>
  Want It.  This journey is all yours.  You will have help, but it is up to you to take<br>
